...
def take_snapshot(device):
	...
	result.writeToFile(os.path.realpath(os.path.dirname(__file__))+"/localswvideo_" + gen_png_no() +".png","png")
...
def main():
	...
	for dev_id in sys.argv[1:]:
		...
		srcfile = os.path.realpath(os.path.dirname(__file__))+'/big_buck_bunny_480p_H264_AAC_25fps_1800K_short.MP4'
		...
		init()
                ...
                device.startActivity(uri='file:///data/local/tests/big_buck_bunny_480p_H264_AAC_25fps_1800K_short.MP4',component='com.android.gallery3d/.app.MovieActivity')
