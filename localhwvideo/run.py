...
def take_snapshot(device):
    ...
    result.writeToFile(file_path + "/localhwvideo_" + gen_png_no() + ".png",
                       "png")


def init():
    os.system("rm" + file_path + "/*.png 2> /dev/null")
...
def main():
    ...
    for dev_id in sys.argv[1:]:
        ...
        mp4_file_name = 'big_buck_bunny_1080p_H264_AAC_25fps_7200K_short.MP4'
        srcfile = file_path + '/' + mp4_file_name
